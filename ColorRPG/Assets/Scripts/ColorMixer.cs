...
public class ColorMixer : MonoBehaviour
{
    ...
    private float[] CalculateReflectance(Color c)
    {
    ...
    private float[,] RGBFromReflectance(float[] reflectance)
    {
    ...
    public Color MixColor(Color a, Color b, float weightA, float weightB)
    {
